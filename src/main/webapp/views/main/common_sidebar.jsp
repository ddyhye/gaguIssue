              ...
              <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                  ...
                  <c:if test="${de_name eq '경영지원부서' || de_name eq '임원진'}">
	                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="<c:url value='/businessPartnerList.go'/>">
	                      <svg class="stroke-icon">
                  ...
                  <!-- 경영지원부서만 보여야 함 -->
                  <c:if test="${de_name eq '경영지원부서' || de_name eq '임원진'}">
	                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="<c:url value='/storageManage.go'/>">
	                      <svg class="stroke-icon">
